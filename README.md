...
A Light-weight Beautiful Admin Template for creating awesome dashboards. Keeping up with the latest design trends, Purple Admin manifests a vibrant design with the splendid use of gradient colors. It has a unique interface with a neat and well-organized set of components.
